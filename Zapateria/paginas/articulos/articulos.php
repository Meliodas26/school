...
<!-- CONTENIDO -->
    <main>
      ...
      <div class=" container row mg-5 ">
          <a href="calzado.php"><button id="calzado" class="btn btn-menu btn-calzado btn-secondary btn-lg ">Calzado</button></a>
      </div>
      <div class=" container row mg-5 ">
          <a href="ropa.php"><button id="ropa" type="button" class="btn btn-menu btn-ropa btn-secondary btn-lg ">Ropa</button></a>
      </div>
